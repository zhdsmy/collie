...
export const zh: Dictionary = {
  ...
  // --- modelPresets ---
  "modelPresets.title": "模型预设",
  "modelPresets.description": "保存模型和思考等级组合，以便快速切换。",
  "modelPresets.openAria": "打开模型预设",
  "modelPresets.listAria": "已保存的模型预设",
  "modelPresets.empty": "还没有保存的预设。",
  "modelPresets.editing": "编辑预设",
  "modelPresets.add": "添加预设",
  "modelPresets.manage": "编辑列表",
  "modelPresets.native": "选择模型",
  "modelPresets.save": "保存预设",
  "modelPresets.cancel": "取消",
  "modelPresets.delete": "删除",
  "modelPresets.deleteAria": "删除 {model}",
  "modelPresets.moveUp": "上移预设",
  "modelPresets.moveDown": "下移预设",
  "modelPresets.model": "模型",
  "modelPresets.modelPlaceholder": "gpt-…",
  "modelPresets.effort": "思考等级",
  "modelPresets.current": "当前预设",
  "modelPresets.unnamed": "未命名预设",
  "modelPresets.invalid": "请输入不含空格或控制字符的模型名，模型和等级组合不能重复。",
  "modelPresets.storageError": "无法将预设保存到此设备。",
  "modelPresets.busy": "正在切换…",
  "modelPresets.working": "正在应用模型和思考等级…",
  "modelPresets.blocked": "当前无法切换",
  "modelPresets.idleRequired": "Codex 正在运行，请在空闲时切换模型。",
  "modelPresets.unsupportedModel": "Codex 不支持该模型。",
  "modelPresets.unsupportedEffort": "该模型不支持此思考等级。",
  "modelPresets.changed": "模型和思考等级已改变。",
  "modelPresets.unconfirmed": "无法确认新的设置。",
  "modelPresets.success": "当前使用 {model} · {effort}",
  "modelPresets.opening": "正在打开模型选择器…",
  "modelPresets.cancelled": "模型切换已取消。",
  "modelPresets.effort.none": "无",
  "modelPresets.effort.minimal": "极低",
  "modelPresets.effort.low": "低",
  "modelPresets.effort.medium": "中",
  "modelPresets.effort.high": "高",
  "modelPresets.effort.xhigh": "极高",
