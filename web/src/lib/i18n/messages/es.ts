...
export const es: Dictionary = {
  ...
  // --- modelPresets ---
  "modelPresets.title": "Preajustes de modelo",
  "modelPresets.description": "Guarda combinaciones de modelo y nivel de razonamiento para cambiar rápido.",
  "modelPresets.openAria": "Abrir preajustes de modelo",
  "modelPresets.listAria": "Preajustes de modelo guardados",
  "modelPresets.empty": "No hay preajustes guardados.",
  "modelPresets.editing": "Editar preajustes",
  "modelPresets.add": "Añadir preajuste",
  "modelPresets.manage": "Editar lista",
  "modelPresets.native": "Elegir modelo",
  "modelPresets.save": "Guardar preajustes",
  "modelPresets.cancel": "Cancelar",
  "modelPresets.delete": "Eliminar",
  "modelPresets.deleteAria": "Eliminar {model}",
  "modelPresets.moveUp": "Subir preajuste",
  "modelPresets.moveDown": "Bajar preajuste",
  "modelPresets.model": "Modelo",
  "modelPresets.modelPlaceholder": "gpt-…",
  "modelPresets.effort": "Nivel de razonamiento",
  "modelPresets.current": "Preajuste actual",
  "modelPresets.unnamed": "preajuste sin nombre",
  "modelPresets.invalid": "Introduce un modelo sin espacios ni caracteres de control y usa cada combinación de modelo y nivel una sola vez.",
  "modelPresets.storageError": "No se pudieron guardar los preajustes en este dispositivo.",
  "modelPresets.busy": "Cambiando…",
  "modelPresets.working": "Aplicando el modelo y el nivel de razonamiento…",
  "modelPresets.blocked": "El cambio no está disponible",
  "modelPresets.idleRequired": "Codex está trabajando. Cambia de modelo cuando esté inactivo.",
  "modelPresets.unsupportedModel": "Ese modelo no está disponible en Codex.",
  "modelPresets.unsupportedEffort": "Ese nivel no está disponible para este modelo.",
  "modelPresets.changed": "Modelo y nivel de razonamiento cambiados.",
  "modelPresets.unconfirmed": "No se pudo confirmar la nueva configuración.",
  "modelPresets.success": "Usando {model} · {effort}",
  "modelPresets.opening": "Abriendo el selector de modelos…",
  "modelPresets.cancelled": "Cambio de modelo cancelado.",
  "modelPresets.effort.none": "Ninguno",
  "modelPresets.effort.minimal": "Mínimo",
  "modelPresets.effort.low": "Bajo",
  "modelPresets.effort.medium": "Medio",
  "modelPresets.effort.high": "Alto",
  "modelPresets.effort.xhigh": "Extra alto",
  "modelPresets.effort.max": "Máximo",
