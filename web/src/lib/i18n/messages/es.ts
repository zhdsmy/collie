...
export const es: Dictionary = {
  ...
  "settings.navGlass.title": "Navegación de inicio",
  ...
  "codexModel.sessionPending": "Esperando que se registre esta sesión de Codex. Los modelos recientes se guardarán para esta sesión.",
  "codexModel.switching": "Cambiando modelo…",
  "codexModel.stop": "Detener",
  "codexModel.stage.model": "Seleccionando modelo",
  "codexModel.stage.effort": "Seleccionando nivel de razonamiento",
  "codexModel.stage.advanced": "Seleccionando razonamiento avanzado",
  "codexModel.stage.scope": "Elige en Codex dónde aplicar este cambio.",
  "codexModel.stage.verifying": "Verificando modelo y razonamiento",
  "codexModel.stopped": "Cambio detenido. Se conservan los cambios ya aplicados.",
  ...
  "codexModel.clearHistory": "Borrar historial",
  "codexModel.clearHistoryConfirm": "Toca otra vez para borrar",
  "codexModel.native": "Elegir modelo",
  "codexModel.busy": "Cambiando…",
  "codexModel.blocked": "El cambio no está disponible",
  "codexModel.idleRequired": "Codex está trabajando. Cambia de modelo cuando esté inactivo.",
  "codexModel.unsupportedModel": "Ese modelo no está disponible en Codex.",
  "codexModel.unsupportedEffort": "Ese nivel no está disponible para este modelo.",
  "codexModel.changed": "Modelo y nivel de razonamiento cambiados.",
  ...
  "codexFast.title": "Modo Fast",
  "codexFast.on": "ACTIVADO",
  "codexFast.off": "DESACTIVADO",
  "codexFast.unknown": "DESCONOCIDO",
  "codexFast.switching": "CAMBIANDO…",
  "codexFast.blocked": "El modo Fast no se puede cambiar ahora. Espera a que la entrada de Codex esté lista.",
  "codexFast.idleRequired": "El modo Fast se puede cambiar cuando Codex está inactivo.",
  "codexFast.busy": "Hay una operación en curso. Espera un momento.",
  "codexFast.changed": "El estado del terminal cambió. Confirma el modo actual y vuelve a intentarlo.",
  ...
  "chat.sessionInfo.model": "Modelo",
  "chat.sessionInfo.provider": "Proveedor",
  "chat.sessionInfo.directory": "Directorio",
  "chat.sessionInfo.session": "ID de sesión",
  "chat.sessionInfo.build": "Versión",
  "chat.sessionInfo.tools": "Herramientas",
  "chat.sessionInfo.mcp": "Servidores MCP",
  "chat.sessionInfo.skills": "Habilidades",
  "chat.sessionInfo.user": "Tú",
  "chat.sessionInfo.event": "Evento",
  ...
  "quickActions.item.yes": "Sí",
  "quickActions.item.no": "No",
  "quickActions.item.continue": "Continuar",
  "quickActions.item.commitPush": "Hacer commit y push",
  "quickActions.item.retry": "Reintentar",
  "quickActions.item.skip": "Omitir",
  ...
  "dialog.picker.currentAria": "Selección actual",
  "dialog.picker.previewAria": "Vista previa del selector",
  "dialog.picker.footerAria": "Ayuda del teclado",
  "dialog.picker.searchPlaceholder": "Buscar opciones",
  "prompt.approval.environment": "Entorno",
  "prompt.approval.reason": "Motivo",
  "prompt.approval.command": "Comando",
  ...
  "dialog.picker.browseUp": "Ver opciones anteriores",
  "dialog.picker.browseDown": "Ver opciones siguientes",
  "dialog.picker.moveUpAria": "Mover {label} arriba",
