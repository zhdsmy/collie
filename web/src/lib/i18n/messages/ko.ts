...
export const ko: Dictionary = {
  ...
  // --- modelPresets ---
  "modelPresets.title": "모델 프리셋",
  "modelPresets.description": "모델과 추론 수준 조합을 저장해 빠르게 전환합니다.",
  "modelPresets.openAria": "모델 프리셋 열기",
  "modelPresets.listAria": "저장된 모델 프리셋",
  "modelPresets.empty": "저장된 프리셋이 없습니다.",
  "modelPresets.editing": "프리셋 편집",
  "modelPresets.add": "프리셋 추가",
  "modelPresets.manage": "목록 편집",
  "modelPresets.native": "모델 선택",
  "modelPresets.save": "프리셋 저장",
  "modelPresets.cancel": "취소",
  "modelPresets.delete": "삭제",
  "modelPresets.deleteAria": "{model} 삭제",
  "modelPresets.moveUp": "프리셋 위로 이동",
  "modelPresets.moveDown": "프리셋 아래로 이동",
  "modelPresets.model": "모델",
  "modelPresets.modelPlaceholder": "gpt-…",
  "modelPresets.effort": "추론 수준",
  "modelPresets.current": "현재 프리셋",
  "modelPresets.unnamed": "이름 없는 프리셋",
  "modelPresets.invalid": "공백이나 제어 문자가 없는 모델을 입력하고 모델/수준 조합을 중복하지 마세요.",
  "modelPresets.storageError": "이 기기에 프리셋을 저장할 수 없습니다.",
  "modelPresets.busy": "전환 중…",
  "modelPresets.working": "모델과 추론 수준을 적용하는 중…",
  "modelPresets.blocked": "전환할 수 없음",
  "modelPresets.idleRequired": "Codex가 작업 중입니다. 유휴 상태에서 모델을 전환하세요.",
  "modelPresets.unsupportedModel": "해당 모델은 Codex에서 사용할 수 없습니다.",
  "modelPresets.unsupportedEffort": "이 모델에서는 해당 추론 수준을 사용할 수 없습니다.",
  "modelPresets.changed": "모델과 추론 수준이 변경되었습니다.",
  "modelPresets.unconfirmed": "새 설정을 확인할 수 없습니다.",
  "modelPresets.success": "사용 중: {model} · {effort}",
  "modelPresets.opening": "모델 선택기를 여는 중…",
  "modelPresets.cancelled": "모델 전환이 취소되었습니다.",
  "modelPresets.effort.none": "없음",
  "modelPresets.effort.minimal": "최소",
  "modelPresets.effort.low": "낮음",
  "modelPresets.effort.medium": "중간",
  "modelPresets.effort.high": "높음",
  "modelPresets.effort.xhigh": "매우 높음",
  "modelPresets.effort.max": "최대",
  "modelPresets.effort.ultra": "울트라",
