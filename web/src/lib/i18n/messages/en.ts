...
export const en = {
  ...
  "settings.navGlass.title": "Home navigation appearance",
  "settings.navGlass.react": "liquid-glass-react",
  "settings.navGlass.dom": "liquid-dom",
  ...
  "codexModel.native": "Choose model",
  "codexModel.busy": "Switching…",
  "codexModel.blocked": "Switching is unavailable",
  "codexModel.idleRequired": "Codex is working. Switch models when it is idle.",
  "codexModel.unsupportedModel": "That model is not available in Codex.",
  "codexModel.unsupportedEffort": "That thinking level is not available for this model.",
  "codexModel.changed": "Model and thinking level changed.",
  ...
  "codexFast.title": "Fast mode",
  "codexFast.on": "ON",
  "codexFast.off": "OFF",
  "codexFast.unknown": "UNKNOWN",
  "codexFast.switching": "SWITCHING…",
  "codexFast.blocked": "Fast mode cannot be switched right now. Wait for Codex input to be ready.",
  "codexFast.idleRequired": "Fast mode can be changed when Codex is idle.",
  "codexFast.busy": "An operation is already in progress. Please wait.",
  "codexFast.changed": "The terminal state changed. Confirm current mode and try again.",
  ...
  "chat.sessionInfo.model": "Model",
  "chat.sessionInfo.provider": "Provider",
  "chat.sessionInfo.directory": "Directory",
  "chat.sessionInfo.session": "Session ID",
  "chat.sessionInfo.build": "Build",
  "chat.sessionInfo.tools": "Tools",
  "chat.sessionInfo.mcp": "MCP servers",
  "chat.sessionInfo.skills": "Skills",
  "chat.sessionInfo.user": "You",
  "chat.sessionInfo.event": "Event",
  ...
  "prompt.approval.environment": "Environment",
  "prompt.approval.reason": "Reason",
  "prompt.approval.command": "Command",
