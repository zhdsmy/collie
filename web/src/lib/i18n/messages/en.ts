...
export const en = {
  ...
  // --- modelPresets ---
  "modelPresets.title": "Model presets",
  "modelPresets.description": "Save model and thinking-level combinations for quick switching.",
  "modelPresets.openAria": "Open model presets",
  "modelPresets.listAria": "Saved model presets",
  "modelPresets.empty": "No saved presets.",
  "modelPresets.editing": "Edit presets",
  "modelPresets.add": "Add preset",
  "modelPresets.manage": "Edit list",
  "modelPresets.native": "Choose model",
  "modelPresets.save": "Save presets",
  "modelPresets.cancel": "Cancel",
  "modelPresets.delete": "Delete",
  "modelPresets.deleteAria": "Delete {model}",
  "modelPresets.moveUp": "Move preset up",
  "modelPresets.moveDown": "Move preset down",
  "modelPresets.model": "Model",
  "modelPresets.modelPlaceholder": "gpt-…",
  "modelPresets.effort": "Thinking level",
  "modelPresets.current": "Current preset",
  "modelPresets.unnamed": "unnamed preset",
  "modelPresets.invalid": "Enter a model without spaces or control characters, and use each model/level pair once.",
  "modelPresets.storageError": "Couldn’t save presets on this device.",
  "modelPresets.busy": "Switching…",
  "modelPresets.working": "Applying model and thinking level…",
  "modelPresets.blocked": "Switching is unavailable",
  "modelPresets.idleRequired": "Codex is working. Switch models when it is idle.",
  "modelPresets.unsupportedModel": "That model is not available in Codex.",
  "modelPresets.unsupportedEffort": "That thinking level is not available for this model.",
  "modelPresets.changed": "Model and thinking level changed.",
  "modelPresets.unconfirmed": "The new setting could not be confirmed.",
  "modelPresets.success": "Using {model} · {effort}",
  "modelPresets.opening": "Opening model picker…",
  "modelPresets.cancelled": "Model switch cancelled.",
  "modelPresets.effort.none": "None",
  "modelPresets.effort.minimal": "Minimal",
  "modelPresets.effort.low": "Low",
  "modelPresets.effort.medium": "Medium",
  "modelPresets.effort.high": "High",
  "modelPresets.effort.xhigh": "Extra high",
  "modelPresets.effort.max": "Max",
  "modelPresets.effort.ultra": "Ultra",
