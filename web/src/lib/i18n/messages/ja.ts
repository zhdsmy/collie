...
export const ja: Dictionary = {
  ...
  // --- modelPresets ---
  "modelPresets.title": "モデルプリセット",
  "modelPresets.description": "モデルと推論レベルの組み合わせを保存して素早く切り替えます。",
  "modelPresets.openAria": "モデルプリセットを開く",
  "modelPresets.listAria": "保存済みモデルプリセット",
  "modelPresets.empty": "保存済みのプリセットはありません。",
  "modelPresets.editing": "プリセットを編集",
  "modelPresets.add": "プリセットを追加",
  "modelPresets.manage": "リストを編集",
  "modelPresets.native": "モデルを選択",
  "modelPresets.save": "プリセットを保存",
  "modelPresets.cancel": "キャンセル",
  "modelPresets.delete": "削除",
  "modelPresets.deleteAria": "{model}を削除",
  "modelPresets.moveUp": "プリセットを上へ",
  "modelPresets.moveDown": "プリセットを下へ",
  "modelPresets.model": "モデル",
  "modelPresets.modelPlaceholder": "gpt-…",
  "modelPresets.effort": "推論レベル",
  "modelPresets.current": "現在のプリセット",
  "modelPresets.unnamed": "名前なしプリセット",
  "modelPresets.invalid": "空白や制御文字を含まないモデル名を入力し、モデルとレベルの組み合わせを重複させないでください。",
  "modelPresets.storageError": "この端末にプリセットを保存できませんでした。",
  "modelPresets.busy": "切り替え中…",
  "modelPresets.working": "モデルと推論レベルを適用しています…",
  "modelPresets.blocked": "切り替えできません",
  "modelPresets.idleRequired": "Codexが実行中です。アイドル時にモデルを切り替えてください。",
  "modelPresets.unsupportedModel": "そのモデルはCodexで利用できません。",
  "modelPresets.unsupportedEffort": "その推論レベルはこのモデルで利用できません。",
  "modelPresets.changed": "モデルと推論レベルを変更しました。",
  "modelPresets.unconfirmed": "新しい設定を確認できませんでした。",
  "modelPresets.success": "使用中: {model} · {effort}",
  "modelPresets.opening": "モデル選択を開いています…",
  "modelPresets.cancelled": "モデルの切り替えをキャンセルしました。",
  "modelPresets.effort.none": "なし",
  "modelPresets.effort.minimal": "最小",
  "modelPresets.effort.low": "低",
  "modelPresets.effort.medium": "中",
  "modelPresets.effort.high": "高",
  "modelPresets.effort.xhigh": "超高",
  "modelPresets.effort.max": "最大",
  "modelPresets.effort.ultra": "ウルトラ",
