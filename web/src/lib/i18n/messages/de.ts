...
export const de: Dictionary = {
  ...
  "settings.navGlass.title": "Startnavigation",
  ...
  "codexModel.sessionPending": "Warten auf die Codex-Sitzung. Zuletzt verwendete Modelle werden für diese Sitzung gespeichert.",
  "codexModel.switching": "Modell wird gewechselt…",
  "codexModel.stop": "Stoppen",
  "codexModel.stage.model": "Modell auswählen",
  "codexModel.stage.effort": "Denkstufe auswählen",
  "codexModel.stage.advanced": "Erweiterte Denkstufe auswählen",
  "codexModel.stage.scope": "Wähle in Codex, wo die Änderung gelten soll.",
  "codexModel.stage.verifying": "Modell und Denkstufe prüfen",
  "codexModel.stopped": "Wechsel gestoppt. Bereits übernommene Änderungen bleiben bestehen.",
  ...
  "codexModel.native": "Modell auswählen",
  "codexModel.busy": "Wird umgeschaltet…",
  "codexModel.blocked": "Umschalten ist nicht verfügbar",
  "codexModel.idleRequired": "Codex arbeitet. Modelle können im Leerlauf gewechselt werden.",
  "codexModel.unsupportedModel": "Dieses Modell ist in Codex nicht verfügbar.",
  "codexModel.unsupportedEffort": "Diese Denkstufe ist für dieses Modell nicht verfügbar.",
  "codexModel.changed": "Modell und Denkstufe geändert.",
  ...
  "codexFast.title": "Fast-Modus",
  "codexFast.on": "AN",
  "codexFast.off": "AUS",
  "codexFast.unknown": "UNBEKANNT",
  "codexFast.switching": "WECHSEL…",
  "codexFast.blocked": "Der Fast-Modus kann gerade nicht gewechselt werden. Warte, bis die Codex-Eingabe bereit ist.",
  "codexFast.idleRequired": "Der Fast-Modus kann geändert werden, wenn Codex untätig ist.",
  "codexFast.busy": "Ein Vorgang läuft bereits. Bitte warten.",
  "codexFast.changed": "Der Terminalstatus hat sich geändert. Prüfe den aktuellen Modus und versuche es erneut.",
  ...
  "chat.sessionInfo.model": "Modell",
  "chat.sessionInfo.provider": "Anbieter",
  "chat.sessionInfo.directory": "Arbeitsordner",
  "chat.sessionInfo.session": "Sitzungs-ID",
  "chat.sessionInfo.build": "Version",
  "chat.sessionInfo.tools": "Werkzeuge",
  "chat.sessionInfo.mcp": "MCP-Server",
  "chat.sessionInfo.skills": "Fähigkeiten",
  "chat.sessionInfo.user": "Du",
  "chat.sessionInfo.event": "Ereignis",
  ...
  "harnessBar.summarize": "Zusammenfassen",
  ...
  "prompt.approval.environment": "Umgebung",
  "prompt.approval.reason": "Grund",
  "prompt.approval.command": "Befehl",
