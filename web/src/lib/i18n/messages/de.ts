...
export const de: Dictionary = {
  ...
  // --- modelPresets ---
  "modelPresets.title": "Modell-Voreinstellungen",
  "modelPresets.description": "Modell und Denkstufe zum schnellen Umschalten speichern.",
  "modelPresets.openAria": "Modell-Voreinstellungen öffnen",
  "modelPresets.listAria": "Gespeicherte Modell-Voreinstellungen",
  "modelPresets.empty": "Keine Voreinstellungen gespeichert.",
  "modelPresets.editing": "Voreinstellungen bearbeiten",
  "modelPresets.add": "Voreinstellung hinzufügen",
  "modelPresets.manage": "Liste bearbeiten",
  "modelPresets.native": "Modell auswählen",
  "modelPresets.save": "Voreinstellungen speichern",
  "modelPresets.cancel": "Abbrechen",
  "modelPresets.delete": "Löschen",
  "modelPresets.deleteAria": "{model} löschen",
  "modelPresets.moveUp": "Voreinstellung nach oben",
  "modelPresets.moveDown": "Voreinstellung nach unten",
  "modelPresets.model": "Modell",
  "modelPresets.modelPlaceholder": "gpt-…",
  "modelPresets.effort": "Denkstufe",
  "modelPresets.current": "Aktuelle Voreinstellung",
  "modelPresets.unnamed": "unbenannte Voreinstellung",
  "modelPresets.invalid": "Modell ohne Leer- oder Steuerzeichen eingeben; jede Kombination aus Modell und Stufe nur einmal verwenden.",
  "modelPresets.storageError": "Voreinstellungen konnten auf diesem Gerät nicht gespeichert werden.",
  "modelPresets.busy": "Wird umgeschaltet…",
  "modelPresets.working": "Modell und Denkstufe werden angewendet…",
  "modelPresets.blocked": "Umschalten ist nicht verfügbar",
  "modelPresets.idleRequired": "Codex arbeitet. Modelle können im Leerlauf gewechselt werden.",
  "modelPresets.unsupportedModel": "Dieses Modell ist in Codex nicht verfügbar.",
  "modelPresets.unsupportedEffort": "Diese Denkstufe ist für dieses Modell nicht verfügbar.",
  "modelPresets.changed": "Modell und Denkstufe geändert.",
  "modelPresets.unconfirmed": "Die neue Einstellung konnte nicht bestätigt werden.",
  "modelPresets.success": "Verwendet: {model} · {effort}",
  "modelPresets.opening": "Modellauswahl wird geöffnet…",
  "modelPresets.cancelled": "Modellwechsel abgebrochen.",
  "modelPresets.effort.none": "Keine",
  "modelPresets.effort.minimal": "Minimal",
  "modelPresets.effort.low": "Niedrig",
  "modelPresets.effort.medium": "Mittel",
  "modelPresets.effort.high": "Hoch",
  "modelPresets.effort.xhigh": "Extra hoch",
  "modelPresets.effort.max": "Maximal",
