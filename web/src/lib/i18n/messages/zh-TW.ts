...
export const zhTW: Dictionary = {
  ...
  // --- modelPresets ---
  "modelPresets.title": "模型預設",
  "modelPresets.description": "儲存模型與思考等級組合，快速切換。",
  "modelPresets.openAria": "開啟模型預設",
  "modelPresets.listAria": "已儲存的模型預設",
  "modelPresets.empty": "尚未儲存預設。",
  "modelPresets.editing": "編輯預設",
  "modelPresets.add": "新增預設",
  "modelPresets.manage": "編輯清單",
  "modelPresets.native": "選擇模型",
  "modelPresets.save": "儲存預設",
  "modelPresets.cancel": "取消",
  "modelPresets.delete": "刪除",
  "modelPresets.deleteAria": "刪除 {model}",
  "modelPresets.moveUp": "上移預設",
  "modelPresets.moveDown": "下移預設",
  "modelPresets.model": "模型",
  "modelPresets.modelPlaceholder": "gpt-…",
  "modelPresets.effort": "思考等級",
  "modelPresets.current": "目前預設",
  "modelPresets.unnamed": "未命名預設",
  "modelPresets.invalid": "請輸入不含空白或控制字元的模型名稱，模型與等級組合不可重複。",
  "modelPresets.storageError": "無法將預設儲存至此裝置。",
  "modelPresets.busy": "正在切換…",
  "modelPresets.working": "正在套用模型與思考等級…",
  "modelPresets.blocked": "目前無法切換",
  "modelPresets.idleRequired": "Codex 正在執行，請在閒置時切換模型。",
  "modelPresets.unsupportedModel": "Codex 不支援此模型。",
  "modelPresets.unsupportedEffort": "此模型不支援這個思考等級。",
  "modelPresets.changed": "模型與思考等級已變更。",
  "modelPresets.unconfirmed": "無法確認新的設定。",
  "modelPresets.success": "目前使用 {model} · {effort}",
  "modelPresets.opening": "正在開啟模型選擇器…",
  "modelPresets.cancelled": "模型切換已取消。",
  "modelPresets.effort.none": "無",
  "modelPresets.effort.minimal": "極低",
  "modelPresets.effort.low": "低",
  "modelPresets.effort.medium": "中",
  "modelPresets.effort.high": "高",
  "modelPresets.effort.xhigh": "極高",
  "modelPresets.effort.max": "最大",
