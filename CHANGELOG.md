...
- **Codex submits replies beside its compact warning footer.** Recognize the warning-only fullscreen row after typing while preserving input verification before Enter.
