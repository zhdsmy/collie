...
- **Direct input uses one consistent icon system and optical size across every keyboard control.** (9056d78)

## [0.34.0+collie.11] - 2026-08-25

### Added

- **Direct input adds an icon-only Enter key and keyboard-ordered navigation rail.** (aa957c3)

## [0.34.0+collie.10] - 2026-08-25

### Changed

- **Reply input restores the upstream Composer layout.** (c6f91ca)

## [0.34.0+collie.9] - 2026-08-25

### Added

- **Codex Composer adds live permissions, model, Fast, and Plan controls.** (7d23ca3)

## [0.34.0+collie.8] - 2026-08-24

### Fixed

- **Multiline replies use a strict three-line viewport above a fixed action row.** (6fc8a28)

## [0.34.0+collie.7] - 2026-08-24

### Fixed

- **Reply input grows to three centred rows, then scrolls clear of its buttons.** (f6a332d)

## [0.34.0+collie.6] - 2026-08-24

### Fixed

- **Pure Codex image replies verify against the live composer draft and submit without a caption.** (bd1d203)

## [0.34.0+collie.5] - 2026-08-24

### Fixed

- **Collapsed replies use full-width text rows and show exactly three complete lines.** (674cfc7)

## [0.34.0+collie.4] - 2026-08-24

### Fixed

- **Expanded replies use the full text width and Send has no persistent background.** (e99335e)
...
- **Terminal output renderer restored to the notification-fix baseline before table transformations.** (d7f4c89)

## [0.32.0+collie.32] - 2026-08-23

### Fixed

- **Terminal tables now preserve Codex-sized columns on one shared horizontal scroll rail.** (f229445)

## [0.32.0+collie.31] - 2026-08-23

### Fixed

- **Codex single-spaced mixed `━`/`─` table rules now enter compact rendering instead of leaking as visible rails.** (9b49899)
...
- **TUI-wrapped tables with lost cell boundaries fall back to readable single-viewport text.** (5bfbe33)
...
- **Terminal tables restore shared columns with left-aligned text, right-aligned numbers, and quiet row rules.** (9634caf)
...
- **Pane activity retracts pending or delivered notifications while retaining the notification repair.** (91a956b)
- **Reverted the compact Agent Markdown view to the stable terminal representation.** (07c393a)
...
- **Tab rename stays open when its keyboard hides pane chrome.** The title and Tab row retain their state while visually hidden, and the rename sheet remains viewport-bound.
...
- **Agent command dock is shorter.** Its fixed body now shows about three command rows by default while remaining responsive to the software-keyboard viewport.
...
- **Shift+Tab reaches terminal applications as BackTab**, restoring approval-mode cycling from the Composer Keys tray when Herdr drops the Shift modifier.
